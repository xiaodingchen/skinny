...
class lib_routing_route
{
	 ...
	 * Run the route action and return the response.
	 *
	 * @param  lib_http_request  $request
	 * @return mixed
	 */
	...
	public static function getValidators()
	{
		...
		return static::$validators = array(
			new lib_routing_matching_method, new lib_routing_matching_scheme,
			new lib_routing_matching_host, new lib_routing_matching_uri,
		);
	}
