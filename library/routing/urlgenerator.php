...
class lib_routing_urlgenerator {
	 ...
	 * @return void
	 */
	public function __construct(lib_routing_collection $routes, lib_http_request $request)
	{
		$this->routes = $routes;
	 ...
	 * @return void
	 */
	public function setRequest(lib_http_request $request)
	{
