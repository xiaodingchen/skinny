...
use lib_support_contracts_interface_jsonable as Jsonable;
use lib_support_contracts_interface_arrayable as Arrayable;
use lib_support_arr as Arr;

class lib_support_collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    /**
